...
![p-value](https://sciencebasedmedicine.org/wp-content/uploads/2017/08/p_value.png){: width="400" height="400"}
...
이 정의를 기억하시고 먼저 한 예제를 푼다음에 그 의미를 곱씹어볼께요.

## 예제
정규분포를 따르고 평균은 알려져있지않고 분산은 100이라고 알려져있는 분포가 있습니다.

여기서 52개의 표본을 취하여 구한 평균이 62.75라고 해봅시다. 

이때 우리는 평균이 60보다 클것이라고 생각하고 다음과 같이 가정을 세웁니다.
